...
an embedding \(F(\alpha)\to\overline F\) by Chapter~9.  Extend it to \(E\)
...
\label{thm:finite-galois-closure}
...
Chapter~11. There the compatible restrictions among the groups
