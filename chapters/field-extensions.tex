...
\section{Extensions and Degree}
The vector-space language developed in Chapter~6 is therefore immediately
...
appear in \S10.2; its powers \(1,t,t^2,\ldots\) cannot fit into any finite
basis.
...
in \S10.1.  The polynomial \(x^2-3\) has no root in
...
Chapter~5} makes the principal ideal \((f)\) maximal; hence the quotient is a
...
\(\sqrt[3]2\) are its three complex cube roots; Chapter~11 will explain why
...
A Galois-theoretic proof of that theorem appears later in Chapter~12.
\end{exercise}
