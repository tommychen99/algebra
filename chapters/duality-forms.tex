...
\(T^*\) used for the inner-product adjoint in Chapter~8.  The construction
...
bilinear forms.  Over \(\mathbb C\), the inner products of Chapter~8 are
Hermitian: they are linear in the first variable and conjugate-linear in the
second.  Thus Chapter~8 is not merely the complex special case of this
bilinear discussion.
