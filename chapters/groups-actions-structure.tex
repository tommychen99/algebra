...
\end{theorem}
\begin{proof}
We use the standard theorem that \(A_n\) is a nonabelian simple group for
\(n\geq5\); its proof is outside the present Sylow-and-composition-series
scope. Since \(A_n\) is nonabelian, its derived subgroup \([A_n,A_n]\) is
