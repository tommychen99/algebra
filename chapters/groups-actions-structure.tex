...
\begin{proposition}
This operation makes \(N\rtimes_\alpha H\) a group; \(N\times\{e_N\}\) is
...
\[
 (n,h)(n',e_H)(n,h)^{-1}=
 \bigl(n\alpha(h)(n')n^{-1},e_H\bigr)\in N\times\{e_N\},
\]
so \(N\times\{e_N\}\) is normal. The two subgroups meet only in
\((e_N,e_H)\).
\end{proof}
