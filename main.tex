...
\newtheorem{applicationtheorem}[theorem]{Theorem}
\newtheorem{undefinition}[theorem]{Definition}
% Exercises have their own counter within each chapter; they do not share the
% theorem/proposition sequence.
\newtheorem{exercise}{Exercise}[chapter]
\theoremstyle{remark}
\newtheorem{remark}[theorem]{Remark}
\newtheorem{unremark}[theorem]{Remark}
\newcommand{\highlight}[1]{\textbf{#1}}
\renewcommand{\emph}[1]{\textbf{#1}}
\newcommand{\descriptivesubsection}[1]{%
  \phantomsection
  \subsection*{#1}%
...
\vfill
% Version 1.3 is the next substantive release after maintenance Version 1.22.
...
\mainmatter
% The first \chapter increments this counter, so the preliminary chapter is
% visibly Chapter 0 and all dependent section, theorem, exercise, and equation
% counters retain the standard book-class numbering.
\setcounter{chapter}{-1}
\input{chapters/introduction}
\part{Groups}
\input{chapters/groups-foundations}
\input{chapters/groups-actions-structure}
\part{Rings and Polynomial Rings}
\input{chapters/rings-ideals}
\input{chapters/polynomials-factorization}
\part{Modules and Linear Algebra}
\input{chapters/modules}
\input{chapters/pid-modules-linear-algebra}
\input{chapters/inner-product-spaces}
\input{chapters/tensor-products}
\part{Fields and Galois Theory}
\input{chapters/field-extensions}
\input{chapters/separability-normality}
\input{chapters/galois-theory}
\backmatter
